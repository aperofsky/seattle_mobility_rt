...
# analysis takes 45 min
#     user    system   elapsed
# 12537.09  1979.08  2668.74
...
save(actual_data_and_perm, file = "//data//perofskyamc//hCoV_HKU1_NL63_mobility_CCF_5mo_sliding_window_actual_and_null_output.RData")
