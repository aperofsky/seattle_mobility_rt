...
# analysis takes 18 min
#     user    system   elapsed
# 12003.252    46.374  2210.206
...
save(actual_data_and_perm, file = "//data//perofskyamc//hmpv_mobility_CCF_5mo_sliding_window_actual_and_null_output.RData")
