...
## H3N2 2019
####################################
H3N2_2019 <- filter_fun(pathogen_df %>% filter(date < as.Date("2019-05-30") & date>as.Date("2018-11-13")))

# ggplot(H3N2_2019)+
#   geom_line(aes(x=date,y=confirm))

date <- as.Date("2018-11-13") + seq(0, along.with = c(NA, H3N2_2019$confirm))
