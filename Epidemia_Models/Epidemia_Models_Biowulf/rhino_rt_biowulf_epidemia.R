...
date <- as.Date("2018-11-20") + seq(0, along.with = c(NA, Rhino_2018_2022$confirm))
...
all_rhino_rt = rhino_rt_2018_2022 %>% group_by(group,tag,level) %>% tidyr::complete(date=full_seq(date,1))%>% ungroup() 
