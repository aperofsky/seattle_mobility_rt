...
## HPIV 2020
####################################
HPIV_2020 <- filter_fun(pathogen_df %>% filter(date>as.Date("2019-08-14") & date<as.Date("2020-04-15"))) %>% filter(date<as.Date("2020-02-15"))

# ggplot(HPIV_2020) +
#   geom_line(aes(x = date, y = confirm))

date <- as.Date("2019-08-13") + seq(0, along.with = c(NA, HPIV_2020$confirm))
