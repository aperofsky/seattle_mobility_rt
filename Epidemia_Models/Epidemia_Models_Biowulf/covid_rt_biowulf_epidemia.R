...
## add 7-day moving average to reduce noise but not oversmooth (covid cases already have 7-day moving average applied by SKC)
...
date <- as.Date("2020-02-18") + seq(0, along.with = c(NA, COVID_2020_SKC_smooth$confirm))
