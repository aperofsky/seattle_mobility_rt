...
dir <- "~/OneDrive - National Institutes of Health/NIH_Laptop_Updates_Post_Damage/Documents/Seattle_Flu_Study/Seattle_SG_Mobility/SG_data/" # filepath to my SG data
...
ext_behavior_daily_data <- read_csv("1_Seattle_Mobility_Data/mobility_data/covidcast_fb_osi_combined_dataset.csv")
...
unique(naics_filt$industry) # 29 categories
...
write_rds(combined_mob2, file = "1_Seattle_Mobility_Data/mobility_data/mobility_metrics_for_epidemia.rds")