...
Adeno_2018_2022 <- Adeno_2018_2022 %>% filter(date < as.Date("2022-07-01") & date > as.Date("2018-11-29"))
# ggplot(Adeno_2018_2022)+
#   geom_line(aes(x=date,y=confirm))
# range(Adeno_2018_2022$date)

date <- as.Date("2018-11-29") + seq(0, along.with = c(NA, Adeno_2018_2022$confirm))
