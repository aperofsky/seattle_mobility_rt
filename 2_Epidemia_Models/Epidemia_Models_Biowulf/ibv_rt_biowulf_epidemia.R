...
## IVB 2020
####################################
IVB_2020 <- filter_fun(pathogen_df %>% filter(date > as.Date("2019-09-04") & date < as.Date("2020-04-20"))) %>% filter(date > as.Date("2019-09-22"))
# ggplot(IVB_2020)+
#   geom_line(aes(x=date,y=confirm))
# range(IVB_2020$date)

date <- as.Date("2019-09-22") + seq(0, along.with = c(NA, IVB_2020$confirm))
