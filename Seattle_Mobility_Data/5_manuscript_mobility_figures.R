...
## Figure 16: Omicron period % change in baseline for large scale movements and different POI categories; % staying home and % masking
####################################################################################
...
p <- ggplot() +
  ...
  ylim(-90, 90)
p
save_plot(p, filename = "Seattle_Mobility_Data/mobility_figures/fig_s4_individual_mobility_metrics.png", base_width = 16, base_height = 10)
...
combined
save_plot(combined, filename = "Seattle_Mobility_Data/mobility_figures/fig_2_mobility_flow_and_poi_visits_time_series.png", base_width = 14, base_height = 14)
...
omicron_combined
save_plot(omicron_combined, filename = "Seattle_Mobility_Data/mobility_figures/fig_s16_omicron_period_mobility_flow_and_poi_visits_time_series.png", base_width = 10, base_height = 14)
save_plot(omicron_combined, filename = "figures/fig_s16_omicron_period_mobility_flow_and_poi_visits_time_series.png", base_width = 10, base_height = 14)
